...
public class OvalCheck extends JCheckBox implements MouseListener, MouseMotionListener {
    ...
    private ImageIcon emptyIcon = new ImageIcon(".\\ItemGeneratorTest\\Images\\CheckIcon.png");
     ...
     */
    public OvalCheck(int shape, int orientation) {
     ...
     */
    public OvalCheck(int shape, int orientation, Color colorNormal, Color colorHighlighted, Color colorBorderNormal, Color colorBorderHighlighted) {
        super();
